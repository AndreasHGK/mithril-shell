      ...
      Service =
        ...
        in
        {
          ...
          Environment = with pkgs; [
            "PATH=${bun}/bin:${coreutils}/bin:${sassc}/bin:${swaynotificationcenter}/bin:${wl-clipboard}/bin:${grim}/bin:${libnotify}/bin:${gammastep}/bin:${bash}/bin:${gnome-control-center}/bin"
          ];
        };
    };
